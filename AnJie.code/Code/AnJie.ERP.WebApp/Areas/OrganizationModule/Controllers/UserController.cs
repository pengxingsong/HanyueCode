...
namespace AnJie.ERP.WebApp.Areas.OrganizationModule.Controllers
{
    ...
    {
        readonly BaseUserBll base_userbll = new BaseUserBll();
        BaseCompanyBll base_companybll = new BaseCompanyBll();
        readonly BaseObjectUserRelationBll base_objectuserrelationbll = new BaseObjectUserRelationBll();
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult SubmitUserForm(string KeyValue, Base_User base_user, string BuildFormJson)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    BaseDataScopePermissionBLL.Instance.AddScopeDefault(ModuleId, ManageProvider.Provider.Current().UserId, base_user.UserId, isOpenTrans);
                }
