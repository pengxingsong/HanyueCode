...
namespace AnJie.ERP.WebApp.Areas.SystemModule.Controllers
{
    /// <summary>
    /// Excel导入控制器
    /// </summary>
    public class ExcelImportController : PublicController<Base_ExcelImport>
    {
        ...
        private readonly CodeMaticBll codematicbll = new CodeMaticBll();
        private readonly BaseDataBaseBLL base_databasebll = new BaseDataBaseBLL();
        private readonly Base_ExcelImportBll base_exceliportbll = new Base_ExcelImportBll();
