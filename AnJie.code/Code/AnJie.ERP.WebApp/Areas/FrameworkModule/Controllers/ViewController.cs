...
namespace AnJie.ERP.WebApp.Areas.FrameworkModule.Controllers
{
    ...
    {
        private readonly BaseModuleBll base_modulebll = new BaseModuleBll();
        private readonly BaseViewBll base_viewbll = new BaseViewBll();
        private readonly BaseViewWhereBll base_viewwherebll = new BaseViewWhereBll();
        /// <summary>
        /// 【视图设置】模块目录
        /// </summary>
        /// <returns></returns>
