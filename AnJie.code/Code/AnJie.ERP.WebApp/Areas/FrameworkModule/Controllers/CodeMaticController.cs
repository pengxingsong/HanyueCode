...
namespace AnJie.ERP.WebApp.Areas.FrameworkModule.Controllers
{
    ...
    {
        readonly CodeMaticBll codematicbll = new CodeMaticBll();
        readonly BaseDataBaseBLL base_databasebll = new BaseDataBaseBLL();
        /// <summary>
        /// 代码生成 初始化页面
        /// </summary>
        /// <returns></returns>
        ...
        {
            var path = Server.MapPath("~/CodeMatic/" + table + ".zip");
