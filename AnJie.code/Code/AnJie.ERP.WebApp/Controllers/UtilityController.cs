...
namespace AnJie.ERP.WebApp.Controllers
{
    ...
    public class UtilityController : Controller
    {
        ...
        public ActionResult LoadButton()
        {
            ...
            List<Base_Button> list = baseButtonpermissionbll.GetButtonList(objectId, moduleId).FindAll(t => t.Enabled == 1);
        ...
        {
            BaseViewPermissionBll base_viewpermissionbll = new BaseViewPermissionBll();
            string ObjectId = ManageProvider.Provider.Current().ObjectId;
            string ModuleId = DESEncrypt.Decrypt(CookieHelper.GetCookie("ModuleId"));
        ...
        #region 公共查询
        public BaseQueryRecordBll base_queryrecordbll = new BaseQueryRecordBll();
        /// <summary>
        /// 【查询页面】
        /// </summary>
        /// <returns></returns>
        ...
        readonly BaseProvinceCityBll base_provincecitybll = new BaseProvinceCityBll();
        /// <summary>
        /// 获取省、市、区 列表
        /// </summary>
