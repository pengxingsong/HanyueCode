...
{
    public class PlatformMerchantsAuthBLL: RepositoryFactory<PlatformMerchantsAuthEntity>
    {
        /// <summary>
        /// 调试日志
        /// </summary>
        private static LogHelper _log = LogFactory.GetLogger("PlatformMerchantsAuthBLL");
        ...
        /// 数据表名称
        /// </summary>
        private readonly string _dbTableName = "Base_PlatformMerchantsAuth";

        /// <summary>
        /// 默认数据返回字段
        /// </summary>
        private readonly string _returnFields = "ID,PlatformID,PlatformName,MerchantID,MerchantCode,MerchantName,MallName,MallID,MallCode,AppKey,AppSecret,Description,IsDisabled,IsDeleted,CreateDate,CreateUserName,ModifyDate,ModifyUserName ";
        ...
        public List<PlatformMerchantsAuthEntity> GetList_ByPlatformID(string platformID)
        {
        ...
        public bool SaveEntity(List<PlatformMerchantsAuthEntity> list)
        {
            try
            {
